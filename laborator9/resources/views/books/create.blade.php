        ...
        <form action="{{ route('books.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4"
                    class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-gray-400">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="flex justify-end space-x-4">
                ...
                <button type="submit"
                    class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Add Book</button>
            </div>
        </form>
    </div>
@endsection